...
VL_INLINE_OPT void Vcounter___024root___sequent__TOP__0(Vcounter___024root* vlSelf) {
    ...
    // Body
    vlSelf->count = ((IData)(vlSelf->arst) ? 0U : (0xffU 
                                                   & ((IData)(vlSelf->count) 
                                                      + (IData)(vlSelf->en))));
}
...
void Vcounter___024root___eval(Vcounter___024root* vlSelf) {
    ...
    // Body
    if ((((IData)(vlSelf->arst) & (~ (IData)(vlSelf->__Vclklast__TOP__arst))) 
         | ((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk))))) {
        Vcounter___024root___sequent__TOP__0(vlSelf);
    }
    // Final
    vlSelf->__Vclklast__TOP__arst = vlSelf->arst;
...
void Vcounter___024root___eval_debug_assertions(Vcounter___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->arst & 0xfeU))) {
